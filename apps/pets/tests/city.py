...
# from ..models import City, CitySerializer
# # tests for models
#
#
# class CityModelTest(APITestCase):
#     def setUp(self):
#         self.a_song = City.objects.create(
...
#         """
#         if title != "" and artist != "":
#             City.objects.create(title=title, artist=artist)
#
...
#
#
# class GetAllCityTest(BaseViewTest):
#
...
#
#
# class GetASingleCityTest(BaseViewTest):
#
...
#         # fetch the data from db
#         expected = City.objects.get(pk=self.valid_song_id)
#         serialized = CitySerializer(expected)
#         self.assertEqual(response.data, serialized.data)
#         self.assertEqual(response.status_code, status.HTTP_200_OK)
...
#
#
# class AddCityTest(BaseViewTest):
#
...
#
#
# class UpdateCityTest(BaseViewTest):
#
